...
import { Category, ChartComponent, ColumnsDirective, ColumnSeries, DataLabel, Inject, Series, SeriesCollectionDirective, SeriesDirective, SplineAreaSeries, Tooltip } from "@syncfusion/ej2-react-charts"
import { tripXAxis, tripyAxis, userXAxis, useryAxis } from "~/constants";
import { ColumnDirective, GridComponent } from "@syncfusion/ej2-react-grids"


export const clientLoader = async () => {
  // This function is used to fetch data on the client side
  // It can be used to fetch user data, dashboard stats, trips, etc.
  // For example, you can use it to fetch user data from Appwrite or any other source
  // and return it as an object that can be used in the component
  const [
    user,
    dashboardStats,
    trips,
